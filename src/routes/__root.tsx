    ...
    <html lang="en">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          ...
          fbq('init', '417212195915442');
          fbq('track', 'PageView');
        ` }} />
        <noscript dangerouslySetInnerHTML={{ __html: `<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=417212195915442&ev=PageView&noscript=1"/>` }} />
      </head>
      <body>
        {children}
        <Scripts />
